...
impl ApiKeyRepository {
    ...
    #[tracing::instrument(level = "info", skip(self))]
    pub async fn get(&self, id: DbId) -> Result<Option<ApiKey>> {
        let sql_str = format!(
    ...
    #[tracing::instrument(level = "info", skip(self))]
    pub async fn list_for_actor(&self, actor_id: DbId) -> Result<Vec<ApiKey>> {
        let sql_str = format!(
    ...
    #[tracing::instrument(level = "info", skip(self))]
    pub async fn touch_last_used(&self, id: DbId, at: Timestamp) -> Result<()> {
        self.connection
            .execute(
