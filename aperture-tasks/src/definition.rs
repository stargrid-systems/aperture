...
pub struct Capabilities {
    ...
    /// cooperative: the body observes [`TaskContext::check_cancelled`] and unwinds.
...
///
/// The input and output are real types. They are validated and (de)serialized at
/// the boundary, so the body in [`TaskDefinition::run`] only ever sees typed
/// values.
