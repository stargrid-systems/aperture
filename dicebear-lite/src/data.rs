// Constellation style data. Bootstrapped from DiceBear 10.x (CC0 1.0), then
...
pub fn component(name: &str) -> Option<&'static ComponentDef> {
    match name {
        "comet" => Some(&COMP_COMET),
        "constellation" => Some(&COMP_CONSTELLATION),
        "star" => Some(&COMP_STAR),
        "star02" => Some(&COMP_STAR02),
        "star03" => Some(&COMP_STAR03),
        "star04" => Some(&COMP_STAR04),
        "star05" => Some(&COMP_STAR05),
        "star06" => Some(&COMP_STAR06),
        "star07" => Some(&COMP_STAR07),
        "star08" => Some(&COMP_STAR08),
        "star09" => Some(&COMP_STAR09),
        "star10" => Some(&COMP_STAR10),
        "star11" => Some(&COMP_STAR11),
        "star12" => Some(&COMP_STAR12),
        "star13" => Some(&COMP_STAR13),
        "star14" => Some(&COMP_STAR14),
        "star15" => Some(&COMP_STAR15),
        "star16" => Some(&COMP_STAR16),
        "animation" => Some(&COMP_ANIMATION),
        _ => None,
    }
}

pub static CANVAS: &[Node] = &[
    Node::Component {
        name: "star",
...
pub static BG_COLORS: &[&str] = &[
    "#032729", "#032933", "#0d1e2f", "#131e37", "#181a22", "#1f2040", "#27193c", "#2f182d",
];
pub static CON_COLORS: &[&str] = &["#c1e0f0", "#e7ecf0", "#e9dab2", "#ece8dd", "#f1d7d2"];
...
pub const SOURCE_NAME: &str = "Constellation";
pub const CANVAS_W: f64 = 100.0;
pub const CANVAS_H: f64 = 100.0;
